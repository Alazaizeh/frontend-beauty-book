...
const FirebaseRegister = ({ registration, setRegistration, ...others }) => {
  ...
  const registerHandler = async (values, { setErrors, setStatus, setSubmitting }) => {
    try {
      let response = await axios.post(`${process.env.REACT_APP_SERVERIP}/auth/register`, {
        email: values.email,
    ...
    <>
      ...
      <Formik
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          await registerHandler(values, { setErrors, setStatus, setSubmitting });
        }}
      >
